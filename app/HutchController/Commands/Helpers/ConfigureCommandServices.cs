...
namespace Hutch.Controller.Commands.Helpers;
...
public static class ConfigureCommandServices
{
  ...
  /// <returns></returns>
  public static IServiceProvider ConfigureServices(this Command _, InvocationContext c,
    Action<InvocationContext, IServiceCollection> configure)
  {
